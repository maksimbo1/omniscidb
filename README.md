...
# Engine standalone build

Engine standalone (resides in "modin" branch) build requires conda installation:
...
# Engine standalone unit testing

Unit tests can be run with (requires RUN_TESTS to be set upon build):
